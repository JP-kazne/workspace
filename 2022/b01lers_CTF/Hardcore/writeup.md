...
We're looking to find the secret behind this SHA1 hash <d578448067f47a44e1d97974492a07ca4b3f230ae70bb0f9129bb8d62d197703>. Luckily for you, this socket takes  and predicts the dot product of the secret with that bit string (mod 2) with 100% accuracy and sends you back the answer.
```

入力したビット列とフラグの積 (mod2) を返してくれるらしいので、1ビットずつ調べる。 1 が返ってくるならフラグにもビットが立っていることが分かる。
